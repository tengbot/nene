    ...
    <div className="runtime-page">
      <header className="runtime-header">
        <div>
          ...
          <h1>nene local cold-start control room</h1>
          <p>
    ...
    >
      ...
      <aside className="desktop-sidebar">
        <div className="desktop-sidebar-brand">
          <span className="desktop-shell-eyebrow">nene desktop</span>
          <h1>Runtime Console Ready</h1>
          <p>
            One local shell for bootstrap health, local UI verification, and
            OpenClaw gateway inspection.
          </p>
        </div>
        ...
        <nav className="desktop-nav" aria-label="Desktop surfaces">
          ...
          <SurfaceButton
            ...
            label="Nene Account"
            meta="Inspect Local Mode, account adapter state, and legacy cloud profiles"
      ...
      <main className="desktop-shell-stage">
        ...
        <div style={{ display: activeSurface === "web" ? "contents" : "none" }}>
          <SurfaceFrame
            description="Local desktop UI surface served by the repo-local web sidecar."
            src={desktopWebUrl}
            title="nene Local UI"
