...
const GITHUB_BASE_URL =
  "https://github.com/nene-im/nene-desktop/releases/download";
export const R2_BASE_URL = "https://desktop-releases.nene.im";
...
export class ComponentUpdater {
  ...
  constructor(source: UpdateSource = "r2") {
    const envOverride =
      process.env.NENE_COMPONENT_FEED_URL ??
      process.env.NEXU_COMPONENT_FEED_URL;
    this.baseUrl =
