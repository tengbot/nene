const en = {
  ...
  "brand.body":
    "nene turns OpenClaw into a truly ready-to-use product experience, bringing Feishu tools and top-tier model access into one unified workspace.",
  ...
  "brand.github": "Star on GitHub",

  // ── Welcome ──
  "welcome.pageTitle": "Welcome to nene",
  "welcome.mobileLabel": "Client",
  "welcome.title": "Choose how to start",
  "welcome.option.login.title": "Use your nene account",
  "welcome.option.login.badge": "Recommended",
  "welcome.option.login.description":
    "Complete browser-based sign in and instantly access nene hosted premium models and the full product experience.",
  ...
  "welcome.byok.note":
    "Your API key is used only for this client configuration. You do not need to create a nene account first.",
  "welcome.byok.verify.loading": "Verifying...",
  "welcome.byok.verify.idle": "Verify connection",
  "welcome.byok.success": "Connected, enter nene",
  ...
  "welcome.cloudConnectError": "Unable to connect to nene cloud service",
  ...
  "auth.copyright": "© 2026 nene by Refly",
  "auth.desktopConnectPrompt": "Log in to connect your nene Desktop app",
  "auth.welcomeBack": "Welcome back",
  "auth.createAccount": "Create your account",
  "auth.loginSubtitle": "Log in to your digital clone",
  "auth.signupSubtitle": "Sign up to get your nene digital clone",
  ...
  "auth.desktopConnected":
    "Your nene Desktop app is now connected to your cloud account. You can close this tab and return to the desktop app.",
  ...
  // ── Document Titles ──
  "title.signIn": "Sign In · nene",
  "title.claim": "Claim · nene",
  "title.home": "Home · nene",
  "title.integrations": "Integrations · nene",
  "title.skills": "Skills · nene",
  "title.settings": "Settings · nene",
  "title.linkFeishu": "Link Feishu · nene",
  "title.connecting": "Connecting · nene",
  "title.default": "nene",
  ...
  "layout.mobile.homeSubtitle": "Welcome to nene",
  ...
  "layout.empty.description":
    "Set up a platform bot first, then mention @nene or DM the lobster 🦞 in Slack / Discord / WhatsApp — conversations will appear here automatically.",
  "layout.empty.setupBot": "Set up Bot",
  "layout.empty.step1": "Connect a platform",
  "layout.empty.step2": "Mention @nene",
  ...
  "home.channel.addBot": "Add nene Bot",
  ...
  "home.channel.phase.almostReady": "nene is almost ready...",
  "home.channel.phase.done": "All set! nene is ready to chat",
  ...
  "home.seedance.promo.subtitle":
    "nene now supports Seedance 2.0. Star the repo, join the Feishu group, fill the form, and we'll send you a Key.",
  ...
  "home.seedance.modal.step1.copy":
    "Star the repo on GitHub, then take a screenshot of the page.",
  ...
  "home.seedance.modal.step2.copy":
    "After joining the group and submitting the form, we'll reach out and send you a Key. Enter it in nene Bot to start.",
  "home.seedance.modal.step2.cta": "Join Feishu group",
  "home.seedance.modal.step2.tutorial":
    "Tutorial: How to use Seedance 2.0 in nene Bot",
  ...
  "settings.general.githubStarred": "Thanks for starring the repo",
  ...
  "models.provider.nexu.name": "nene Official",
  "models.provider.nexu.description":
    "Use nene official premium models after login, no API key needed",
  ...
  "models.managed.cloudConnectAria": "Connect to nene cloud",
  "models.managed.cloudDisconnectAria": "Disconnect from nene cloud",
  "models.managed.loginRequired": "Login required",
  "models.managed.cloudConnected": "Connected to nene Cloud",
  ...
  "models.managed.loginPrompt": "Sign in to use nene official models",
  "models.managed.loginDescription":
    "Sign in with your nene account to access unlimited premium models like Claude Opus 4.6, GPT-5.4, and more — no API key needed.",
  "models.managed.waitingLogin": "Waiting for browser login...",
  "models.managed.loginButton": "Sign in to nene",
  ...
  "channels.pageSubtitle":
    "Connect your messaging platforms and let nene 🦞 join your workspace",
  ...
  "channels.confirmResetBody":
    "This will remove your current {{platform}} Bot configuration. You will need to complete setup again before nene can receive messages from this platform.",
  ...
  "skills.sourceRecommendedDesc": "Pre-installed skills recommended by nene",
  ...
  "skillDetail.tryPromptsDesc":
    "Copy a prompt and send it to your nene bot to try this skill.",
  ...
  "oauth.requestingAccess":
    "nene is requesting access to your {{name}} account",
  ...
  "oauth.securityNote":
    "nene uses OAuth 2.0. Your credentials are never stored. You can revoke access anytime.",
  "oauth.authSuccess": "Authorization Successful",
  "oauth.connectedTo": "{{name}} has been connected to nene",
  ...
  "claim.linkExpiredDesc":
    "This claim link has expired. Send a message to the nene bot in {{platform}} to get a new one.",
  ...
  "claim.getStarted": "Get started with nene",
  "claim.joinTeam": "Join your team on nene",
  "claim.joinTeamDesc":
    "Sign in to connect your {{platform}} identity and start using nene with your team.",
  ...
  "claim.teammatesAlready":
    "{{count}} teammates already using nene — no additional configuration needed",
  ...
  "claim.teamUsesnexu.line3": "nene",
  "claim.teammatesHere": "{{count}} teammate{{s}} already here",
  "claim.noConfigNeeded":
    "Your team has already connected nene — no additional configuration needed. Just sign in to get started.",
  "claim.claimAccess": "Claim your {{platform}} access",
  "claim.claimAccessDescExisting":
    "Connect your {{platform}} identity to your nene account and join {{team}}.",
  "claim.claimAccessDescNew":
    "Link your {{platform}} identity to your nene account to unlock AI-powered workflows.",
  ...
  "claim.claimingDesc":
    "Linking your {{platform}} identity to your nene account.",
  "claim.allSet": "You're all set!",
  "claim.allSetDesc": "Your {{platform}} account has been linked to nene.",
  "claim.nowPartOf": "You're now part of",
  "claim.backTo": "Back to {{platform}}",
  "claim.explorenexu": "Explore nene",

  // ── Feishu Bind Page ──
  "feishuBind.linked": "Feishu account linked!",
  "feishuBind.linkedDesc":
    "Your Feishu identity has been linked to your nene account. You can now use the bot normally.",
  "feishuBind.backToFeishu": "Back to Feishu",
  "feishuBind.explorenexu": "Explore nene",
  ...
  "feishuBind.linkDesc":
    "Connect your Feishu account to nene to unlock AI-powered workflows directly in your chats.",
  "feishuBind.linkAccount": "Link your Feishu account",
  "feishuBind.signInFirst":
    "Sign in to nene first, then bind your Feishu identity.",
  "feishuBind.authorizeDesc":
    "Authorize with Feishu to link your identity to your nene account.",
  ...
  "telegramSetup.desc":
    "Create a bot in BotFather, paste the token here, then add the bot to any group where you want replies. nene will reply in groups only when the bot is mentioned.",
  ...
  "qqbotSetup.desc":
    "Create a QQ bot app, paste the App ID and Secret here, then let nene reply through the bundled OpenClaw plugin.",
  ...
  "slackSetup.addnexuTitle": "Add nene to Slack",
  "slackSetup.addnexuDesc":
    "One-click install \u2014 authorize nene Bot to your Slack workspace via OAuth",
