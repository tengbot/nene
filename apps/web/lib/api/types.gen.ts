...
export type GetApiInternalDesktopNeneStatusData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetApiInternalDesktopNeneStatusResponses = {
    /**
     * nene desktop integration status
     */
    200: {
        connectionStatus?: 'disconnected' | 'configured' | 'connected' | 'error';
        lastDeviceRegistrationAt?: string;
        lastEntitlementSyncAt?: string;
...
export type GetApiInternalDesktopNeneStatusResponse = GetApiInternalDesktopNeneStatusResponses[keyof GetApiInternalDesktopNeneStatusResponses];
